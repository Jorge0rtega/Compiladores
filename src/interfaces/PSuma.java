...
public class PSuma extends JDialog implements ActionListener{
    JLabel inst, ind;
    ...
    public PSuma(java.awt.Frame parent, boolean model, AFN f[], int n){
        super(parent,model);
        fs = f;
        index=n;
        ind = new JLabel("AFN ID." + index + ":");
        inst = new JLabel("\n Elige el AFN al que se le aplicara la cerradura suma:");
