 ...
 * @author Jorge Ortega
 */
public class PAnaLex extends javax.swing.JFrame {
    int cont;
    AFN[] f;
    String archivoAFN;
    String sigma;
    ...
    /**
     * Creates new form PAnaLex
     */
    public PAnaLex(int cont, AFN[] f) {
        this.cont=cont;
        this.f=f;
...
////            java.util.logging.Logger.getLogger(PAnaLex.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
