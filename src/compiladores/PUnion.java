...
public class PUnion extends JDialog implements ActionListener{
    JLabel inst, ind;
    ...
    public PUnion(java.awt.Frame parent, boolean model, AFN f[], int n){
        super(parent,model);
        fs = f;
        index=n;
    ...
    public void actionPerformed(ActionEvent e ){
        if(e.getSource()==aceptar){
            ...
            a = a.unirAFN(fs[n2]);
            index = index + 1;
            JOptionPane.showMessageDialog(this, "Se unieron los AFN's "  + n1 + n2);
