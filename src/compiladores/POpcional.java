...
public class POpcional extends JDialog implements ActionListener{
    JLabel inst, ind;
    ...
    public POpcional(java.awt.Frame parent, boolean model, AFN f[], int n){
        super(parent,model);
        fs = f;
        index=n;
    ...
    public void actionPerformed(ActionEvent e ){
        if(e.getSource()==aceptar){
            ...
            a.opcional();
            index = index + 1;
            JOptionPane.showMessageDialog(this, "Se aplico cerrasura Opcional al AFN "  + n1);
